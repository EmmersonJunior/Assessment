...
public class DeviceAlert1
{
    public DeviceAlert1()
    {
    }

    public DeviceAlert1(AlertTypeEnum alertTypeEnum, DeviceReading deviceReading, string description, decimal readingValue)
    {
    ...
    public DeviceAlert1(AlertTypeEnum alertTypeEnum, DeviceReading deviceReading, string description)
    {
        AlertType = alertTypeEnum;
        DeviceReadingId = deviceReading.DeviceReadingId;
        AlertDescription = description;
